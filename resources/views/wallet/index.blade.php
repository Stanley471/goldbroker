...
<head>
    ...
    <title>My Vault - GoldBroker</title>
                ...
                <div x-show="tab === 'holdings'">
                    @if(count($holdingsGrouped) > 0)
                        <div class="mb-6 flex items-center justify-between">
                            <p class="text-[#A0A0A0]">Showing {{ count($holdingsGrouped) }} product(s)</p>
                            <a href="{{ route('wallet.locations') }}" class="inline-flex items-center gap-2 text-[#D4AF37] hover:text-[#B8860B] transition-colors">
