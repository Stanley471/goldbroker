...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-white" style="font-family: 'Playfair Display';">Add Crypto Wallet</h1>
        <p class="text-[#A0A0A0] mt-1">Add a new cryptocurrency deposit address</p>
    </div>

    <div class="max-w-2xl">
        <form action="{{ route('admin.crypto-wallets.store') }}" method="POST" class="bg-[#141414] border border-[#D4AF37]/20 rounded-xl p-8">
            @csrf

            <div class="grid grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block text-sm text-[#A0A0A0] mb-2">Currency Name *</label>
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Bitcoin" required
                ...
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" placeholder="e.g. BTC" required
            ...
            <div class="grid grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="symbol" value="{{ old('symbol') }}" placeholder="e.g. ₿"
                        class="w-full bg-[#0A0A0A] border border-[#D4AF37]/30 rounded-xl px-4 py-3 text-white placeholder-[#666] focus:border-[#D4AF37] focus:outline-none transition-colors">
                ...
                <div>
                    ...
                    <input type="text" name="network" value="{{ old('network') }}" placeholder="e.g. ERC-20, TRC-20"
                        class="w-full bg-[#0A0A0A] border border-[#D4AF37]/30 rounded-xl px-4 py-3 text-white placeholder-[#666] focus:border-[#D4AF37] focus:outline-none transition-colors">
            ...
            <div class="mb-6">
                ...
                <textarea name="address" rows="3" placeholder="Enter the wallet address..." required
                    class="w-full bg-[#0A0A0A] border border-[#D4AF37]/30 rounded-xl px-4 py-3 text-white placeholder-[#666] focus:border-[#D4AF37] focus:outline-none transition-colors font-mono text-sm">{{ old('address') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="number" name="exchange_rate" value="{{ old('exchange_rate', 1) }}" step="0.0000000001" min="0.0000000001" required
                ...
                <p class="text-xs text-[#666] mt-1">1 {{ old('code', 'UNIT') }} = how many USD? e.g. BTC = ~65000</p>
