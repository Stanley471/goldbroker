...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-white" style="font-family: 'Playfair Display';">Edit Bank Account</h1>
        <p class="text-[#A0A0A0] mt-1">Update {{ $bankAccount->bank_name }} account details</p>
    </div>

    <div class="max-w-2xl">
        <form action="{{ route('admin.bank-accounts.update', $bankAccount) }}" method="POST" class="bg-[#141414] border border-[#D4AF37]/20 rounded-xl p-8">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <textarea name="bank_address" rows="2" placeholder="Full bank address"
                    class="w-full bg-[#0A0A0A] border border-[#D4AF37]/30 rounded-xl px-4 py-3 text-white placeholder-[#666] focus:border-[#D4AF37] focus:outline-none transition-colors">{{ old('bank_address', $bankAccount->bank_address) }}</textarea>
            ...
            <div class="grid grid-cols-3 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="routing_number" value="{{ old('routing_number', $bankAccount->routing_number) }}" placeholder="For ACH/Domestic"
                        class="w-full bg-[#0A0A0A] border border-[#D4AF37]/30 rounded-xl px-4 py-3 text-white placeholder-[#666] focus:border-[#D4AF37] focus:outline-none transition-colors">
                ...
                <div>
                    ...
                    <input type="text" name="swift_code" value="{{ old('swift_code', $bankAccount->swift_code) }}" placeholder="For International"
                        class="w-full bg-[#0A0A0A] border border-[#D4AF37]/30 rounded-xl px-4 py-3 text-white placeholder-[#666] focus:border-[#D4AF37] focus:outline-none transition-colors">
                ...
                <div>
                    ...
                    <input type="text" name="iban" value="{{ old('iban', $bankAccount->iban) }}" placeholder="For SEPA"
                        class="w-full bg-[#0A0A0A] border border-[#D4AF37]/30 rounded-xl px-4 py-3 text-white placeholder-[#666] focus:border-[#D4AF37] focus:outline-none transition-colors">
            ...
            <div class="grid grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="number" name="sort_order" value="{{ old('sort_order', $bankAccount->sort_order) }}" min="0"
                        class="w-full bg-[#0A0A0A] border border-[#D4AF37]/30 rounded-xl px-4 py-3 text-white placeholder-[#666] focus:border-[#D4AF37] focus:outline-none transition-colors">
            ...
            <div class="mb-8">
                ...
                <textarea name="instructions" rows="3" placeholder="Any special instructions for users..."
                    class="w-full bg-[#0A0A0A] border border-[#D4AF37]/30 rounded-xl px-4 py-3 text-white placeholder-[#666] focus:border-[#D4AF37] focus:outline-none transition-colors">{{ old('instructions', $bankAccount->instructions) }}</textarea>
